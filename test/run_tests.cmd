...
REM Script to run the unit-tests for the calendar Vim plugin on MS-Windows
...
%VIM_CMD% -c "vim9cmd g:TestName = 'test_calendar.vim'" -S "runner.vim"
...
echo CALENDAR unit test results
type results.txt
